...
<head>
    ...
    html, body {
        ...
        /* Specific styles for the "Login as Admin" title and subtitle */
        .page-header-text {
            ...
            <div class="col-lg-6 col-md-8 d-flex justify-content-center">
                <div class="card rounded-card">
                    ...
                    <div class="form-middle">
                        <form action="../includes/adlogger.php" method="POST" class="form-fields">

                            <div class="mb-3">
                                <input type="email" class="form-control" name="admin_email" placeholder="E-Mail" required>
                            </div>
                            <div class="mb-3">
                                <input type="password" class="form-control" name="admin_password" placeholder="Password" required>
                            </div>
                            <?php
                                if (isset($_SESSION["adloginerror"])) {
                                    echo '<div class="alert alert-danger mt-3">'.$_SESSION["adloginerror"].'</div>';
                                    unset($_SESSION["adloginerror"]); // Clear the error after displaying
                                }
                            ?>
