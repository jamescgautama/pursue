...
<head>
    ...
    <title>Discover Projects | Pursue</title>
...
<div class="discover-container">
    ...
    <div class="search-container">
        ...
        <input type="text" id="search" class="search-input" placeholder="Search by name or description...">
    </div>
    ...
    <div class="loading-container" id="loading" style="display: none;">
        ...
        <p class="mt-2 text-muted">Searching projects...</p>
    </div>
...
$(document).ready(function() {
    function loadRecords(query = '') {
        ...
        $.ajax({
            url: 'includes/discoverprojects.php', 
            method: 'GET', 
            data: {query: query}, 
            ...
            error: function() {
                $('#results').html('<div class="col-12"><div class="no-results"><i class="bi bi-exclamation-triangle"></i><h4>Error Loading Projects</h4><p class="text-muted">Please try again later.</p></div></div>');
                $('#loading').hide();
                $('#results').show();
            }
        });
...
<!-- Documentation:
The purpose of this Discover page for projects is so that job seekers can search startups to work at.
The search functionality is inspired by https://stackoverflow.com/questions/40479400/making-search-function-ajax -->