            ...
            <div class="col-lg-6 col-md-8 d-flex justify-content-center">
                <div class="card rounded-card">
                    <div class="page-header-text">
                        <h2>Be What's Next.</h2>
                        <h1>Sign Up As Project</h1>
                    </div>

                    <div class="form-middle">
                        <form action="includes/prosigner.php" method="POST" class="form-fields">
                            <div class="mb-3">
                            ...
                            <?php
                                if (isset($_SESSION["prosignuperror"])) {
                                    echo '<div class="alert alert-danger mt-3">'.$_SESSION["prosignuperror"].'</div>';
                                    unset($_SESSION["prosignuperror"]); 
                                }
                            ?>
                    ...
                    <p>
                        <a href="../signup.php" class="text-decoration-none" style="color: #F97D37; font-weight: 500;">
                        Or signup as Talent
                    </a>
                </p>
