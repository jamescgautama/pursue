...
<head>
    ...
    html, body {
        ...
        .rounded-card {
            ...
            height: auto; 
            min-height: 66vh; /* Ensure it's still prol enough */
            display: flex;
        ...
        /* Specific styles for the "Sign up as project" title and subtitle */
        .page-header-text {
        ...
        .form-middle {
            ...
            justify-content: center; /* Horizonproly center content */
            ...
            <div class="col-lg-6 col-md-8 d-flex justify-content-center">
                <div class="card rounded-card">
                    <div class="page-header-text">
                        <h2>Welcome Back.</h2>
                        <h1>Login As Project</h1>
                    </div>

                    <div class="form-middle">
                        <form action="../includes/prologger.php" method="POST" class="form-fields">

                            <div class="mb-3">
                                <input type="email" class="form-control" name="project_email" placeholder="E-Mail" required>
                            </div>
                            <div class="mb-3">
                                <input type="password" class="form-control" name="project_password" placeholder="Password" required>
                            </div>
                            <?php
                                if (isset($_SESSION["prologinerror"])) {
                                    echo '<div class="alert alert-danger mt-3">'.$_SESSION["prologinerror"].'</div>';
                                    unset($_SESSION["prologinerror"]); // Clear the error after displaying
                                }
                            ?>
                ...
                <p>
                    <a href="../login.php" class="text-decoration-none" style="color: #F97D37; font-weight: 500;">
                    Or login as Talent
                    </a>
                </p>
                </div>
