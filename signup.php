            ...
            <div class="col-lg-6 col-md-8 d-flex justify-content-center">
                <div class="card rounded-card">
                    <div class="page-header-text">
                        <h2>Join What's Next.</h2>
                        <h1>Sign Up As Talent</h1>
                    </div>

                    <div class="form-middle">
                        <form action="includes/talsigner.php" method="POST" class="form-fields">
                            <div class="mb-3">
                                <input type="text" class="form-control" name="talent_name" placeholder="Full Name" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <?php
                                if (isset($_SESSION["talsignuperror"])) {
                                    echo '<div class="alert alert-danger mt-3">'.$_SESSION["talsignuperror"].'</div>';
                                    unset($_SESSION["talsignuperror"]);
                                }
                            ?>
                    ...
                    <p>
                        <a href="projects/signup.php" class="text-decoration-none" style="color: #F97D37; font-weight: 500;">
                        Or signup as Project
                    </a>
                </p>
